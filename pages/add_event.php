    ...
    <section>
        ...
        <form class="formulario-event" action="./add_event.php" method="POST">
            ...
            <div1>
                ...
                <input placeholder="Descrição" name="description" id="description" required></input>
            </div1>
            <div1>
                <label for="date">Data:</label>
                <input placeholder="Data" type="date" name="date" id="date" required>
            </div1>
            <div1>
                <label for="time">Horário:</label>
                <input type="time" placeholder="Horário" name="time" id="time" required>
            </div1>
            <div1>
                <label for="location">Local:</label>
                <input placeholder="Local" type="text" name="location" id="location" required>
            </div1>
            <div1>
                ...
                if (!empty($categories)) {
                    ...
                    echo "<p>Sem categorias encontradas</p>";
                }
                ?>
            </div1>
            <div1>
                <label for="price">Valor:</label>
                <input placeholder="Valor" type="number" name="price" id="price" step="0.01" required>
            </div1>
            <div1>
                <label for="images">Link da imagem:</label>
                <input placeholder="Link da imagem" type="url" name="images" id="images" required>
            </div1>
            <div1>
                <input type="submit" class="btn-addevent" value="Adicionar Evento">
            </div1>
        </form>
    </section>
