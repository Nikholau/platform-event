            ...
            <section>
                ...
                <section6>
                    <form action="../services/update_event.php" method="POST">
                        ...
                        <label>Título:</label>
                        <input placeholder="Título do evento" type="text" name="title" value="<?php echo $event->getTitle(); ?>"><br>
                        ...
                        <label>Valor:</label>
                        <input placeholder="Valor" type="text" name="price" value="<?php echo $event->getPrice(); ?>"><br>
                        <label>Link da imagem:</label>
                        <input placeholder="Link da imagem" type="text" name="images"
